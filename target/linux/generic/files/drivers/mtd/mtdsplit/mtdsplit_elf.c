			      ...
			      struct mtd_part_parser_data *data)
{
	...
	case ELF_CLASS_32:
		loader_size = hdr.elf32.shoff
			      + hdr.elf32.shnum * hdr.elf32.shentsize;
		break;
	case ELF_CLASS_64:
		loader_size = hdr.elf64.shoff
			      + hdr.elf64.shnum * hdr.elf64.shentsize;
		break;
	default:
