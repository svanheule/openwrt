...
#define ELF_MAGIC		0x79454c46 /* 0x79 E L F */
				...
				struct mtd_part_parser_data *data)
{
	...
	uint16_t shoff, shnum, shentsize;
	...
	rootfs_offset = shoff + shnum * shentsize;

	err = mtd_find_rootfs_from(mtd, mtd->erasesize, mtd->size,
				   &rootfs_offset, NULL);
	if (err)
		return err;
